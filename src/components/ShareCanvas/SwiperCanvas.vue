<template>
	<view class="content" v-if="isShow" @click.stop="isShow=false">
		<swiper class="banner-container" :indicator-dots="false" :autoplay="false" circular="true" duration="1000"
			previous-margin="70rpx" next-margin="55rpx" @change="swiperChange" :current="questionNum"
				...
				<swiper-item class="banner-item">
					<view class="banner-box">
						<canvas @click.stop="" :style="{ width: canvasW + 'px', height: canvasH + 'px' }"
							canvas-id="my-canvas" class="banner-img"></canvas>
					</view>
				</swiper-item>
			</block>
		</swiper>
...
<script>
	export default {
		...
		data() {
			return {
				ImgsList: ['https://app.static.wangxiao.cn/ztb/poster.png',
					'https://app.static.wangxiao.cn/ztb/poster.png', 'https://app.static.wangxiao.cn/ztb/poster.png'
				],
				questionNum: 0,
				canvasW: 0,
				canvasH: 0,
		...
		methods: {
			swiperChange(e) {
				...
				this.bgImg = this.ImgsList[this.questionNum]
				uni.pageScrollTo({
					scrollTop: 0,
					duration: 300
				});
